...
-- GERAL ->
--
-- ARQUIVO RESPONSÁVEL paraesquerdaLA FUNCIONALIDADE DO MENU-INFO E DE TODOS OS OBJETOS E FUNÇÕES NECESSÁRIAS.
-------------------------------------------------------------------------------------------------------------------------------
	...
	-- ARQUIVOS DE ÁUDIO:
		...
		local touchButton = audio.loadSound("Multimidia/Menu/Infos/song_touch_button.mp3");
	...
	-- FUNÇÃO RESPONSÁVEL POR CRIAR OS OBJETOS DA CENA:
		function scene:createScene(event)
			...
			-- TÍTULO:
				...
				local imgTitle = display.newImage("Multimidia/Menu/Infos/img_info_title.png");
					imgTitle.xScale = 0.2;
					imgTitle.yScale = 0.2;
